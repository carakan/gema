...
ActiveRecord::Schema.define(:version => 20110525170553) do
  ...
  create_table "clases", :force => true do |t|
    ...
    t.string   "descripcion", :limit => 600
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "consultas", :force => true do |t|
    ...
    t.string   "busqueda"
    t.string   "parametros",       :limit => 600
    t.string   "comentario",       :limit => 800
    t.string   "marca_ids_serial", :limit => 600, :default => "[]"
