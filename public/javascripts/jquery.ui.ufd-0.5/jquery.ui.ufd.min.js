...
(function(){var g=document.getElementsByTagName("head")[0],i=20,a=["http://ufd.googlecode.com/svn/trunk/src/jquery.ui.ufd.js"],b=["http://ufd.googlecode.com/svn/trunk/css/ufd-base.css","http://ufd.googlecode.com/svn/trunk/css/plain/plain.css"],c=false;if(typeof jQuery=="undefined"){c=true;a.unshift("http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/jquery-ui.min.js");a.unshift("http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js")}else jQuery.ui||a.unshift("http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/jquery-ui.min.js");
for(scriptPtr in a){var d=document.createElement("SCRIPT");d.type="text/javascript";d.src=a[scriptPtr]+"?noCache="+Math.random();g.appendChild(d)}for(cssPtr in b){a=document.createElement("LINK");a.rel="stylesheet";a.type="text/css";a.media="screen";a.href=b[cssPtr];g.appendChild(a)}var f=function(){if(typeof jQuery=="undefined"||typeof jQuery.ui=="undefined"||typeof jQuery.ui.ufd=="undefined")i--?setTimeout(function(){f()},250):alert("failed to intialize UFD bookmarklet sorry.");else{c&&jQuery.noConflict();
jQuery("select:not([multiple])").ufd()}};f()})();
